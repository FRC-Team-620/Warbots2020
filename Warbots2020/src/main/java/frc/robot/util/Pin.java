...
public enum Pin {
    ...
    // region Drivetrain
    LeftFrontMotor(1, CommsStandard.CAN), RightFrontMotor(3, CommsStandard.CAN), LeftRearMotor(2, CommsStandard.CAN),
    ...
    ShooterMotor1(9, CommsStandard.CAN), ShooterMotor2(10, CommsStandard.CAN), ClimberMotor(11, CommsStandard.CAN),
    // endregion
     ...
     *
     * MYPIN(3, CommsStandard.PWM), YOURPIN(4, CommsStandard.CAN), THEIRPIN(2,
     * CommsStandard.PWM), ^ ^ ^ ^ ^ ^ Comms Standard ^ Name ^ ^ ^ Comma at the End
     * of a Value Number on Rio or Bus
     * 
     * 
     * 
